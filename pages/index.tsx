...
export default function Home() {
  ...
  function TopicGroup() {
    return (
      <div className="w-full h-fit min-h-[100svh] bg-[#D9D9D9] flex flex-col items-center justify-start gap-y-10">
        <h1 className="mt-20 text-[#960226] font-righteous md:text-[70px] text-[50px]">
          Search By Topic
        </h1>
        <Topics
          title="Scenery"
  ...
  function Topics(data: TopicsTypes) {
    ...
    return (
      <div
        ...
        ref={containerRef}
      >
        <h1 className="text-[#F9F9F9] font-righteous text-[30px] shrink-0 ml-5">
          {title}
        </h1>
