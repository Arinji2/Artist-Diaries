...
import { postName } from "@/utils/postFunc";
    ...
    <div className="w-full h-[100svh] flex md:flex-row items-center justify-center flex-col bg-[#B1B1B1]">
      <div className="md:w-[50%] w-full h-full flex flex-col items-center justify-start gap-5 z-30">
        ...
        <div className="w-full h-full flex flex-col items-center justify-center gap-2">
          ...
          <input
            type="text"
            className="outline-none w-[80%] bg-white rounded-lg p-3 m-3 text-black font-dongle text-4xl"
            placeholder="Name..."
          ...
          <div
            ...
            onClick={() => {
              postName(name, user?.id).then(() => {
                const mode = localStorage.getItem("setupMode");
                if (mode === null) router.push("/artist/setup/about");
