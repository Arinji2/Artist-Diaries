...
function ArtistLogin() {
  ...
  return (
    <div className="w-full md:h-[100svh] h-fit bg-[#3D4A4C] ">
      <div className="h-[30%] flex flex-col items-center justify-center">
        <h2 className="text-6xl text-white pt-32 font-righteous">User Login</h2>
      </div>
      <div className="w-full h-[70%] flex md:flex-row items-center justify-evenly flex-col">
